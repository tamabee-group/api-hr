...
public interface EmployeeDeductionRepository extends JpaRepository<EmployeeDeductionEntity, Long> {
        ...
        /**
         * Lấy tất cả deductions (phân trang)
         * Multi-tenant: không cần filter companyId vì mỗi tenant có DB riêng
         */
        Page<EmployeeDeductionEntity> findByDeletedFalse(Pageable pageable);
