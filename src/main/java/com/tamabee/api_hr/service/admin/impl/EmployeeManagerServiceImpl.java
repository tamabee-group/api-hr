...
public class EmployeeManagerServiceImpl implements IEmployeeManagerService {
    ...
    public UserResponse createTamabeeUser(CreateTamabeeUserRequest request) {
        ...
        emailService.sendTemporaryPassword(savedUser.getEmail(), savedUser.getEmployeeCode(), temporaryPassword, savedUser.getLanguage());
    ...
    public UserResponse updateUserProfile(Long id, UpdateUserProfileRequest request) {
        ...
        if (request.getBankAccount() != null) profile.setBankAccount(request.getBankAccount());
        ...
        if (request.getEmergencyContactRelation() != null) profile.setEmergencyContactRelation(request.getEmergencyContactRelation());
        if (request.getEmergencyContactAddress() != null) profile.setEmergencyContactAddress(request.getEmergencyContactAddress());
