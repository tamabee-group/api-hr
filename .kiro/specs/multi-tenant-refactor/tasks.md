...
- [ ] 1. Setup Multi-Tenant Core Components

  - [ ] 1.1 Tạo TenantContext class (ThreadLocal holder)

    - Tạo file `filter/TenantContext.java`
    - Methods: setCurrentTenant(), getCurrentTenant(), clear()
    - _Requirements: 3.2_

  - [ ] 1.2 Tạo TenantFilter class
  ...
  - [ ] 1.3 Tạo TenantRoutingDataSource class
  ...
  - [ ] 1.4 Tạo TenantDataSourceManager class
  ...
  - [ ] 1.5 Tạo TenantDatabaseInitializer class
  ...
  - [ ]\* 1.6 Write property tests cho TenantContext lifecycle
    - **Property 3: Tenant Context Lifecycle**
    - **Validates: Requirements 3.1, 3.2, 3.4**

- [ ] 2. Checkpoint - Verify core components compile

  - Ensure all tests pass, ask the user if questions arise.

- [ ] 3. Database Schema và Flyway Migration

  - [ ] 3.1 Tạo Master DB migration file
  ...
  - [ ] 3.2 Tạo Tenant DB migration template
  ...
  - [ ] 3.3 Tạo database tamabee_tamabee cho Tamabee

    - Pre-create database cho Tamabee company
    - Run migration V1
    - _Requirements: 2.2_

  - [ ] 3.4 Cấu hình Flyway cho multi-tenant
    - Tạo file `config/FlywayMultiTenantConfig.java`
    - Separate locations cho master và tenant
    - _Requirements: 9.1_

- [ ] 4. Refactor BaseEntity và Soft Delete

  - [ ] 4.1 Bỏ deleted field khỏi BaseEntity

    - Sửa file `entity/BaseEntity.java`
    - Chỉ giữ id, createdAt, updatedAt
    - _Requirements: 6.1_

  - [ ] 4.2 Thêm deleted field vào entities cần soft delete
  ...
  - [ ] 4.3 Xóa deleted field khỏi entities không cần soft delete
  ...
  - [ ] 4.4 Update repositories cho soft delete pattern

    - Entities có soft delete: thêm `AndDeletedFalse` vào queries
    - Entities không có soft delete: bỏ filter deleted
...
- [ ] 5. Checkpoint - Verify entity changes compile

  - Ensure all tests pass, ask the user if questions arise.

- [ ] 6. JWT Enhancement

  - [ ] 6.1 Update JwtService để include tenantDomain và planId
